...
##### 遠ざかる
<video src="./Docs/Videos/Far.mp4" controls width="600"></video>

##### 近づく
<video src="./Docs/Videos/Close.mp4" controls width="600"></video>
...
- **RushAttack (突進攻撃)**
    ...
    <video src="./Docs/Videos/RushAttack.mp4" controls width="600"></video>
...
- **ShockWaveAttack (衝撃波攻撃)**
    ...
    <video src="./Docs/Videos/ShockWave.mp4" controls width="600"></video>
...
#### 観察
<video src="./Docs/Videos/Observation.mp4" controls width="600"></video>

#### 審判を執行する
<video src="./Docs/Videos/Judgement.mp4" controls width="600"></video>
